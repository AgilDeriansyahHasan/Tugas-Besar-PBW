        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              <x-navbar.link href="/admin">Dashboard</x-navbar.link>
              <x-navbar.link href="/candidate">Candidate</x-navbar.link> 
              <x-navbar.link href="/admin/voting">Vote History</x-navbar.link>  
              <x-navbar.link href="/admin/voting">Hasil Voting</x-navbar.link> 
            </div>
          </div>
        </div>
        </div>
