        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              <x-navbar.link href="/user/dashboard">Dashboard</x-navbar.link>
              <x-navbar.link href="/voting/create">Voting</x-navbar.link>
              <x-navbar.link href="/voting">Vote History</x-navbar.link>  
            </div>
          </div>
        </div>
        </div>
